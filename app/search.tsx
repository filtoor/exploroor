    ...
    <div className="flex gap-2 relative w-full">
      ...
      {!searching && (
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          className="w-4 h-4 absolute right-2 top-2 text-zinc-400 hover:cursor-pointer hover:text-white"
          onClick={onSearch}
        >
          <path
      ...
      {searching && (
        <svg
          aria-hidden="true"
          className="absolute right-2 top-2 w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
          viewBox="0 0 100 101"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
